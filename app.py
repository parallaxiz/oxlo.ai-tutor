...
var editor; // Just declare it here
var sidebarVisible = true;

// ... [Keep your SNIPPETS, EXTS, MONO_LANG objects as they are] ...
...
require(['vs/editor/editor.main'], function(){
    ...
    // CRITICAL FIX: Use currentLang here inside the callback
    ...
    // Sync the UI labels to match the selected language
